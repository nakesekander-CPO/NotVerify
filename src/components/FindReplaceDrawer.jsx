    ...
    <Drawer isOpen={isOpen} onClose={onClose} title="Find & Replace" width="lg">
      <div className="space-y-5">
        ...
        <button
          ...
          className="w-full py-2.5 rounded-lg text-sm font-semibold transition-colors flex items-center justify-center gap-2 bg-amber hover:bg-amber-deep text-white disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed"
        >
