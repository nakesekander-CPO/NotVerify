      ...
      <div className="bg-[#ffffff]/60 border border-black/[0.12] rounded-lg mx-6 mb-2 p-4 space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 text-sm text-gray-700">
            <Database className="h-4 w-4 text-[#5c7cfa] shrink-0" />
            <span>
              Matched against <span className="font-[JetBrains_Mono] text-gray-900">{audit.kbMatches}</span> entries in <span className="text-[#5c7cfa]">{audit.kbSource}</span>
            </span>
          </div>
        </div>
    ...
    <section className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2">
          <Brain className="h-5 w-5 text-[#5c7cfa]" />
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="rounded-lg border border-black/[0.12] bg-[#ffffff] px-3 py-1.5 text-sm font-medium text-gray-900 outline-none transition-colors hover:border-black/[0.20] focus:border-[#5c7cfa]/50"
          >
          ...
          className={`flex items-center gap-2 rounded-lg px-5 py-2 text-sm font-semibold transition-all ${
            committed
              ...
              : allResolved && !committing
                ? 'bg-[#5c7cfa] text-white hover:bg-[#4c6ce0]'
