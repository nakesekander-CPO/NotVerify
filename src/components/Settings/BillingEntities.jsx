        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {isEditing ? (
            ...
            <>
              ...
              <button className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[12px] text-gray-400 hover:bg-black/[0.04] hover:text-gray-600 transition-colors cursor-pointer border border-black/[0.06]">
