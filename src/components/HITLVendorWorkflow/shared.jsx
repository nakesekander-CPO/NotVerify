...
const STATUS_TONE = {
  ...
  'not-verified': { bg: 'bg-error/10', text: 'text-error', border: 'border-error/30', icon: AlertTriangle },
  'needs-rework': { bg: 'bg-amber/15', text: 'text-amber-deep', border: 'border-amber/30', icon: AlertTriangle },
  'signed-off': { bg: 'bg-teal/10', text: 'text-teal', border: 'border-teal/30', icon: Check },
  rejected: { bg: 'bg-error/10', text: 'text-error', border: 'border-error/30', icon: AlertTriangle },
  escalated: { bg: 'bg-amber/15', text: 'text-amber-deep', border: 'border-amber/30', icon: AlertTriangle },
