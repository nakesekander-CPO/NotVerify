...
const AUDIT_ENTRIES = [
  ...
  { id: 'gov-6', timestamp: '2026-03-30T15:00:00Z', type: 'review', document: 'Q3_Investor_Presentation.pptx', locale: 'JA', actor: 'Sarah Jenkins', actorRole: 'Compliance Reviewer (APAC)', decision: 'approved', reason: 'All flagged segments verified — currency formatting corrected to \u00a5 standard', policy: 'Human review', market: 'Japan', regulatoryContext: 'TSE', confidenceScore: 90, escalated: false },
