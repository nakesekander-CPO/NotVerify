            ...
            {activeAction === null && (
              ...
              >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium bg-[#5c7cfa] text-white hover:bg-[#4c6ef5] transition-colors"
                >
            ...
            {activeAction === 'annotate' && (
              ...
              >
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-md border border-slate-300 bg-white px-4 py-3 text-sm text-gray-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#5c7cfa]/40 focus:border-[#5c7cfa] resize-none"
                />
                <div className="flex items-center gap-2">
                  <button
                    onClick={handleAnnotationSubmit}
                    disabled={!inputText.trim()}
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium bg-[#5c7cfa] text-white hover:bg-[#4c6ef5] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                  >
                    Save Annotation
                  </button>
                  <button
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Shield className="w-5 h-5 text-[#5c7cfa]" />
          ...
          <nav className="mt-3 flex items-center gap-1.5 text-xs text-gray-400">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-[#5c7cfa] font-medium">
              Compliance Review
            </span>
          </nav>
        </div>
          ...
          <div className="max-w-6xl mx-auto flex items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <div className="h-2 rounded-full bg-slate-100 overflow-hidden">
                <motion.div
                  className="h-full rounded-full bg-[#5c7cfa]"
                  initial={{ width: 0 }}
                  animate={{
            ...
            <button
              ...
              disabled={!canSubmit}
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-md text-sm font-semibold bg-[#5c7cfa] text-white hover:bg-[#4c6ef5] disabled:opacity-40 disabled:cursor-not-allowed transition-colors shrink-0"
            >
          ...
          >
            ...
            <div className="divide-y divide-slate-50">
              {auditLog.map((entry) => (
                ...
                >
                  <span className="font-mono text-xs font-semibold text-[#5c7cfa]">
                    {entry.segRef}
                  </span>
