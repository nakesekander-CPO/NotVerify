...
function RadarChart({ scores, color = '#5c7cfa', size = RADAR_SIZE }) {
    ...
    >
      <div className="p-6">
        <h3 className="text-gray-900 font-semibold text-sm mb-4 flex items-center gap-2">
          <Zap size={16} className="text-[#5c7cfa]" />
        ...
        {phase === 'loading' ? (
          <div className="flex flex-col items-center justify-center py-10 gap-3">
            <motion.div
              ...
              style={{ borderColor: '#5c7cfa', borderTopColor: 'transparent' }}
              animate={{ rotate: 360 }}
    ...
    >
      <div className="p-6">
        <h3 className="text-gray-900 font-semibold text-sm mb-5 flex items-center gap-2">
          <BarChart3 size={16} className="text-[#5c7cfa]" />
          Agent Comparison
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="text-center">
            ...
            <RadarChart scores={a.scores} color="#5c7cfa" />
          </div>
          {/* Agent B radar */}
          <div className="text-center">
  ...
  if (!hiredAgents || hiredAgents.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        >
          <Users size={28} style={{ color: '#5c7cfa' }} />
        </div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 mt-2">
      {hiredAgents.map((agent, idx) => {
        ...
        const iconBg = iconColorMap[agent.icon] || '#5c7cfa'
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  style={{
                    ...
                    focusRingColor: '#5c7cfa',
                  }}
                  onFocus={(e) => (e.target.style.boxShadow = '0 0 0 2px #5c7cfa')}
              ...
              <div className="flex items-center gap-1 mb-4">
                {[
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor:
                        activeTab === tab.key ? '#5c7cfa' : 'transparent',
                  ...
                  {CATEGORIES.map((cat) => (
                    <button
                      ...
                      style={{
                        ...
                        color: activeCategory === cat ? '#5c7cfa' : '#94a3b8',
                        border:
                          activeCategory === cat
                            ? '1px solid rgba(92,124,250,0.3)'
                            ...
                            <div className="flex items-center justify-between mb-2">
                              ...
                              >
                                <input
                                  ...
                                  className="w-3.5 h-3.5 rounded accent-[#5c7cfa]"
                                />
